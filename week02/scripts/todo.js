...
function newTask() {
  ...
  const todoInput = document.createElement('#todo');
...
function manageTasks(event) {
  ...
  // event.target will point to the actual icon clicked on - I.E. which type of button was clicked
  // event.current Target points to the element the listener is attached to
  //We need to get the parent li to work with however. HINT: Remember element.closest()? Look it up if you don't
...
document.createElement('#submitTask').addEventListener('click', newTask);
